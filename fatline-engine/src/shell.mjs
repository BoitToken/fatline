...
<script>
  ...
  function loadPage(name){
    ...
    setTimeout(function(){
      ...
      el.querySelectorAll('img').forEach(function(im){ im.addEventListener('error', function(){ if(this.dataset.fb) return; this.dataset.fb='1'; this.src='https://picsum.photos/seed/fl'+Math.floor(Math.random()*9999)+'/800/600'; }); });
      _icons();
      window.scrollTo(0,0);
    }, 180);
